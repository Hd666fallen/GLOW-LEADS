...
export default function CustomerFunnel() {
  ...
  return (
    <div className="funnel-theme" data-testid="customer-funnel">
      ...
      {/* FIX 2: Color sheet — NO setFingerState so Step 7 customizations are preserved */}
      ...
      {/* FIX 2: Design sheet — NO setFingerState so Step 7 customizations are preserved */}
      ...
      {/* FIX 2: Shape sheet — NO setFingerState so Step 7 customizations are preserved */}
